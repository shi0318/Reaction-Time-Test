...
export interface HomeContent {
  ...
  nav: { play: string; method: string; tools: string; faq: string; language: string };
...
export const HOME_CONTENT: Record<Locale, HomeContent> = {
  en: {
    ...
    nav: { play: 'Play', method: 'How it works', tools: 'Tools', faq: 'FAQ', language: 'Language' },
  ...
  zh: {
    ...
    nav: { play: '开始测试', method: '测试说明', tools: '工具', faq: '常见问题', language: '语言' },
  ...
  ko: {
    ...
    nav: { play: '테스트', method: '작동 방식', tools: '도구', faq: '자주 묻는 질문', language: '언어' },
  ...
  hi: {
    ...
    nav: { play: 'टेस्ट', method: 'कैसे काम करता है', tools: 'टूल', faq: 'सामान्य प्रश्न', language: 'भाषा' },
  ...
  fr: {
    ...
    nav: { play: 'Tester', method: 'Fonctionnement', tools: 'Outils', faq: 'Questions fréquentes', language: 'Langue' },
