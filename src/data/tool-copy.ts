...
export const HUB: Record<Locale, { title: string; description: string; kicker: string; h1: string; lede: string; toolsHeading: string; guidesHeading: string; items: { href: string; label: string; note: string; group: 'tools' | 'guides' }[] }> = {
  en: {
    ...
    items: [
      ...
      { href: '/color-reaction-test/', label: 'Color reaction test', note: 'Click the named color. Decoy colors do not count.', group: 'tools' },
  ...
  zh: {
    ...
    items: [
      ...
      { href: '/zh/color-reaction-test/', label: '颜色反应测试', note: '指定颜色出现时点击，干扰色不计分。', group: 'tools' },
  ...
  ko: {
    ...
    items: [
      ...
      { href: '/ko/color-reaction-test/', label: '색상 반응 테스트', note: '지정한 색만 클릭하세요. 방해 색은 기록되지 않습니다.', group: 'tools' },
  ...
  hi: {
    ...
    items: [
      ...
      { href: '/hi/color-reaction-test/', label: 'रंग प्रतिक्रिया परीक्षण', note: 'बताए गए रंग पर क्लिक करें। गलत रंग नहीं गिने जाते।', group: 'tools' },
  ...
  fr: {
    ...
    items: [
      ...
      { href: '/fr/color-reaction-test/', label: 'Test de réaction aux couleurs', note: 'Cliquez sur la couleur indiquée. Les leurres ne comptent pas.', group: 'tools' },
...
export const COLOR: Record<Locale, VariantCopy> = {
  en: {
    ...
    description: 'Free color reaction test online. Wait for the named color, then click. Decoy colors do not count. Five valid rounds stay in this browser tab.',
    kicker: 'Color test', h1: 'Color Reaction Test', lede: 'The page names a color. Click only when the panel matches it. Early clicks and decoy colors do not count.',
    heading: 'Click the named color, ignore decoys', count: (n) => `${n} of 5 recorded`, begin: 'Click to begin', beginHelp: 'Wait for the named color. A decoy color should not be clicked.', ready: 'Color reaction test ready.',
    aboutTitle: 'How this color reaction test works',
    aboutBody: [
      'Each round names one color, then shows either that color or a decoy after a random delay. A click on the decoy does not record a time. Five valid matching clicks produce best, median and average values.',
      'The main visual test remains on the language homepage. The choice reaction time test uses the same decoy rule with a different page title.',
    ],
    callout: 'Browse the set from the reaction tests list.',
    faqHeading: 'Questions about this test',
    faqs: [
      { question: 'What is a color reaction test?', answer: 'The page names a color, then may show that color or a decoy. Click only the named color. A click on the wrong color is ignored.' },
      { question: 'How is this different from the homepage?', answer: 'The homepage always uses green and has no decoy. This test rotates the named color and ignores clicks on the wrong color.' },
    ],
  },
  zh: {
    title: '颜色反应测试 – 指定颜色出现时点击',
    description: '免费颜色反应测试。等到指定颜色再点击，干扰色不计分。五轮有效成绩保留在当前标签页。',
    kicker: '颜色测试', h1: '颜色反应测试', lede: '页面会指定一种颜色。只有面板变成该颜色时才点击。过早点击和干扰色都不计分。',
    heading: '点击指定颜色，忽略干扰色', count: (n) => `已记录 ${n} / 5`, begin: '点击开始', beginHelp: '等到指定颜色再反应。出现干扰色时不要点。', ready: '颜色反应测试已就绪。',
    aboutTitle: '这个颜色反应测试如何进行',
    aboutBody: [
      '每轮指定一种颜色，随机等待后出现目标色或干扰色。点到干扰色不会记录成绩。五次有效点击后给出最佳值、中位数和平均值。',
      '主视觉测试仍在中文首页。选择反应时间测试用的是同一套干扰色规则。',
    ],
    callout: '可从反应测试目录浏览全部测试。',
    faqHeading: '关于本测试',
    faqs: [
      { question: '什么是颜色反应测试？', answer: '页面指定一种颜色，然后可能出现该颜色或干扰色。只点击指定颜色，点到干扰色不计分。' },
      { question: '和首页有什么不同？', answer: '首页固定使用绿色，没有干扰色。本测试会轮换指定颜色，点错颜色不计分。' },
    ],
  },
  ko: {
    title: '색상 반응 테스트 – 지정한 색이 나타나면 클릭',
    description: '무료 색상 반응 테스트. 지정한 색이 나오면 클릭하세요. 방해 색은 기록되지 않습니다.',
    kicker: '색상 테스트', h1: '색상 반응 테스트', lede: '페이지가 색을 지정합니다. 패널이 그 색일 때만 클릭하세요. 너무 이른 클릭과 방해 색은 무시됩니다.',
    heading: '지정한 색만 클릭하고 방해 색은 무시하세요', count: (n) => `${n} / 5 기록됨`, begin: '클릭하여 시작', beginHelp: '지정한 색을 기다리세요. 방해 색이 나오면 클릭하지 마세요.', ready: '색상 반응 테스트 준비 완료.',
    aboutTitle: '이 색상 반응 테스트의 방식',
    aboutBody: [
      '각 라운드는 한 가지 색을 정한 뒤, 무작위 대기 후 그 색 또는 방해 색을 보여 줍니다. 방해 색을 클릭하면 시간이 기록되지 않습니다.',
      '메인 시각 테스트는 한국어 홈에 있습니다.',
    ],
    callout: '반응 테스트 목록에서 전체를 볼 수 있습니다.',
    faqHeading: '이 테스트에 대해',
    faqs: [
      { question: '색상 반응 테스트란?', answer: '색을 지정한 뒤 그 색 또는 방해 색이 나올 수 있습니다. 지정한 색만 클릭하세요.' },
      { question: '홈과 무엇이 다른가요?', answer: '홈은 항상 초록색이고 방해 색이 없습니다. 이 테스트는 지정 색을 바꾸고 잘못된 클릭을 무시합니다.' },
    ],
  },
  hi: {
    title: 'रंग प्रतिक्रिया परीक्षण – बताए गए रंग पर क्लिक करें',
    description: 'निःशुल्क रंग प्रतिक्रिया परीक्षण। बताए गए रंग आने पर क्लिक करें। गलत रंग नहीं गिने जाते।',
    kicker: 'रंग परीक्षण', h1: 'रंग प्रतिक्रिया परीक्षण', lede: 'पृष्ठ एक रंग बताता है। पैनल उसी रंग का हो तभी क्लिक करें। जल्दी क्लिक और गलत रंग नहीं गिने जाते।',
    heading: 'बताए गए रंग पर क्लिक करें, गलत रंग छोड़ दें', count: (n) => `${n} / 5 दर्ज`, begin: 'शुरू करने के लिए क्लिक करें', beginHelp: 'बताए गए रंग की प्रतीक्षा करें। गलत रंग दिखे तो क्लिक न करें।', ready: 'रंग प्रतिक्रिया परीक्षण तैयार है।',
    aboutTitle: 'यह रंग प्रतिक्रिया परीक्षण कैसे चलता है',
    aboutBody: [
      'हर राउंड एक रंग बताता है, फिर यादृच्छिक प्रतीक्षा के बाद वही रंग या गलत रंग दिखाता है। गलत रंग पर क्लिक समय नहीं जोड़ता।',
      'मुख्य दृश्य परीक्षण हिन्दी होम पर है।',
    ],
    callout: 'सभी परीक्षण प्रतिक्रिया परीक्षण सूची में हैं।',
    faqHeading: 'इस परीक्षण के बारे में',
    faqs: [
      { question: 'रंग प्रतिक्रिया परीक्षण क्या है?', answer: 'पृष्ठ रंग बताता है, फिर वही रंग या गलत रंग दिखा सकता है। केवल बताए गए रंग पर क्लिक करें।' },
      { question: 'होम से यह कैसे अलग है?', answer: 'होम हमेशा हरा रंग इस्तेमाल करता है और गलत रंग नहीं दिखाता। यह परीक्षण रंग बदलता है और गलत क्लिक नहीं गिनता।' },
    ],
  },
  fr: {
    title: 'Test de réaction aux couleurs – cliquez quand la couleur indiquée apparaît',
    description: 'Test gratuit de réaction aux couleurs. Attendez la couleur indiquée, puis cliquez. Les leurres ne comptent pas.',
    kicker: 'Test de couleur', h1: 'Test de réaction aux couleurs', lede: 'La page nomme une couleur. Cliquez seulement lorsque le panneau correspond. Les clics trop tôt et les leurres ne comptent pas.',
    heading: 'Cliquez la couleur indiquée, ignorez les leurres', count: (n) => `${n} sur 5 enregistrés`, begin: 'Cliquez pour commencer', beginHelp: 'Attendez la couleur indiquée. Ne cliquez pas sur un leurre.', ready: 'Test de couleur prêt.',
    aboutTitle: 'Comment fonctionne ce test de couleur',
    aboutBody: [
      'Chaque tour nomme une couleur, puis affiche cette couleur ou un leurre après un délai aléatoire. Un clic sur le leurre n’enregistre pas de temps.',
    ...
    faqHeading: 'Questions sur ce test',
    faqs: [
      { question: 'Qu’est-ce qu’un test de réaction aux couleurs ?', answer: 'La page nomme une couleur, puis peut afficher cette couleur ou un leurre. Cliquez seulement la couleur indiquée.' },
      { question: 'En quoi est-ce différent de la page d’accueil ?', answer: 'La page d’accueil utilise toujours le vert, sans leurre. Ce test fait tourner la couleur et ignore les mauvais clics.' },
    ],
  },
};
...
export const RELATED: Record<Locale, { href: string; label: string; note: string }[]> = {
  en: [
    ...
    { href: '/color-reaction-test/', label: 'Color reaction test', note: 'Click the named color. Decoy colors do not count.' },
  ...
  zh: [
    ...
    { href: '/zh/color-reaction-test/', label: '颜色反应测试', note: '指定颜色出现时点击，干扰色不计分。' },
